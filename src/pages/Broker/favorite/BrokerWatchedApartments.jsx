...
import { Card, Row, Col, Typography, Button, Select, Input, Tag, Space, Empty, message } from 'antd';
...
const BrokerWatchedApartments = () => {
  ...
  const [watchedList, setWatchedList] = useState(mockWatched);
                ...
                <Card
                  ...
                  actions={[
                    <Button
                      type="link"
                      icon={<EyeOutlined />}
                      onClick={() => message.info('Xem chi tiết căn hộ')}
                      key="view"
                    >
                      Xem chi tiết
                    </Button>,
